...
const DashboardSidebar: React.FC<DashboardSidebarProps> = ({ collapsed, onToggle, mobileOpen, onMobileClose }) => {
        ...
        <ul className="space-y-1">
          ...
          <li>
            ...
            >
              ...
              {(!collapsed || mobileOpen) && <span className="font-medium group-hover:text-destructive">Logout</span>}
            </button>
          </li>
        </ul>
      </div>
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed left-0 top-0 z-50 h-screen w-72 bg-sidebar border-r border-sidebar-border transition-transform duration-300 lg:hidden",
